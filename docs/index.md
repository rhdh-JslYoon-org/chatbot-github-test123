...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/chatbot-github-test123](https://github.com/rhdh-JslYoon-org/chatbot-github-test123)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/chatbot-github-test123-gitops](https://github.com/rhdh-JslYoon-org/chatbot-github-test123-gitops)

# **Usage**

To access the chatbot-github-test123 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of chatbot-github-test123. You can access this namespace through the web console or via your CLI.
