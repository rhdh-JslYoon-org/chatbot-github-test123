...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot-github-test123`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-github-test123-notebook`.
...
5) In the terminal, run `cd chatbot-github-test123` to navigate to your sample app's directory.
